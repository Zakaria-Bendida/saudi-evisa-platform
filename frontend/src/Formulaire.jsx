    ...
    <div className="omra-page">
      ...
      <div className="omra-hero">
        ...
        <div className="omra-card">
          {submitted ? (
            <div className="omra-confirmation">
              <div className="omra-confirmation-icon">
                <CheckCircle2 size={40} />
              </div>
              <h2>Demande envoyée avec succès</h2>
              <p>
                Merci, votre demande de visa a bien été reçue. Notre équipe va
                l'examiner et reviendra vers vous par téléphone ou par e-mail
                dès qu'elle aura été traitée.
              </p>
              <div className="omra-confirmation-note">
                <ShieldCheck size={16} />
                Conservez une copie de vos documents (passeport, photo) jusqu'à
                la fin du traitement de votre dossier.
              </div>
              <button
                type="button"
              ...
              >
                        ...
                        return (
                          <label className="omra-chip" key={p.value}>
                            <input
                              type="checkbox"
                              value={p.value}
                              checked={formData.purpose_of_travel.includes(
                                p.value,
                              )}
                              disabled={isDisabled}
                ...
                {step === 1 && (
                  <div id="Div_01">
                    ...
                    >
                      Personnes voyageant sur le même passeport — ايضاحات تخص
                      افراد العائلة المضافين الى جواز السفر : renseignées à
                      l'étape suivante.
                    </p>
                  </div>
                )}
                  ...
                  <div id="Div_02">
                    ...
                    <div className="omra-family-cards" id="T">
                      {familyMembers.length === 0 && (
                        ...
                        >
                          Indiquez le nombre de personnes puis cliquez sur «
                          Générer le tableau ».
                        </p>
                      )}
                  ...
                  <div id="Div_03">
                    ...
                    >
                      <p style={{ margin: "0 0 6px" }}>
                        ...
                        fournies sont exactes et m'engage à respecter les lois
                        du Royaume pendant la durée de mon séjour.
                      </p>
                      <p
                        style={{
                          margin: 0,
                      ...
                      >
                        <input
                          ...
                          onChange={(e) =>
                            setFormData((prev) => ({
                              ...prev,
                              visa_number: e.target.value.replace(
                                /[^0-9]/g,
                                "",
                              ),
                            }))
